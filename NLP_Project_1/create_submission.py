...
def create_submission():
    ...
    if not submission_dir.exists():
        ...
        print("  submission/gru_config.json (included in repo)")
        print("  submission/gru_weights.npz (generated by training)")
        return
    ...
    if size_mb > 1.0:
        ...
        print("Consider:")
        print("  - Reducing embed_dim or hidden_dim")
        print("  - Reducing layers")
